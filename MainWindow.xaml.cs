...
public partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    // MSI-specific identity. Empty when the loaded package is a .pkg or .nupkg;
    // the matching rows collapse in the XAML via the HasXxx flags.
    ...
    // Only show FullVersion when it differs from the displayed Version (cimipkg
    // stores the original date-based version separately from the MSI 3-part form).
